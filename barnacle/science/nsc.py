...
The settings of the script are defined by:
        ...
        * **activate_save_basic_esti**: bool. If ``True``, it gives a broadband
...
activates = (activate_oversampling, activate_preview_only,
             activate_random_init_guesses, activate_photo_resampling,
             activate_save_basic_esti, activate_spectral_sorting,
...
def run_nsc(activates, skip_fit, chi2_map_switch, maps_sz, nbs, which_nulls,
    ...
    #    plt.ioff()
        ...
        if activate_phase_sorting or activate_preview_only:
            data, idx_good_frames = gff.sortFrames(
                data, nb_frames_sorting_binning, 0.1, factor_minus0[idx_null],
                factor_plus0[idx_null], key, plot=activate_preview_only,
                save_path=save_path)
        ...
        if activate_save_basic_esti:
            ...
            basic_save = save_path + key + '_basic_esti' + '_'+str(wl_min) +\
                '-' + str(wl_max) + '_files_' + str(nb_files_data[0]) +\
                '_' + str(nb_files_data[1]) + '_' + \
